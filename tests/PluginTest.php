...
/**
 * @file plugins/generic/viewcounter/tests/PluginTest.php
 *
...
class PluginTest extends PKPTestCase
{
    ...
    {
        return [
            \APP\plugins\generic\viewcounter\ViewcounterPlugin::class,
            \APP\plugins\generic\viewcounter\ViewcounterSettingsForm::class,
        ];
    }
